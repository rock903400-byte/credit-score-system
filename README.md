...
**這個系統是拿來做真實放款決策的嗎？**
不是。這是讓你能理解「信用評分等級怎麼被算出來」的模擬工具，僅供教育與示範用途。

**資料是哪來的？**
全部是合成測試資料，不包含任何真實客戶的個資或授信記錄，可安心下載試玩。

**它依循什麼規則？**
計分核心依照金管會相關授信規定精神設計，並加入 14 條法規級否決規則（如年齡、抵押 LTV 上限等），細節刊載於「評分推論」頁。

**我可以拿去套在自己的工作上嗎？**
可以。整個核心運算只有約 20KB 的原生 JavaScript（core.js），無框架依賴，歡迎改寫或整合到你的系統。
